...
export function ChartRadarEnhanced() {
  return (
    <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 h-full relative overflow-hidden border border-white/20 shadow-2xl">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="pb-0 flex-1">
          <ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[250px]">
            <RadarChart data={chartData}>
              ...
              <PolarAngleAxis dataKey="metric" className="text-white text-xs" />
        ...
        <div className="flex-col gap-2 text-sm pt-4">
          ...
          <div className="text-blue-200 flex items-center gap-2 leading-none">Current survey period metrics</div>
        </div>
      </div>
    </div>
  )
